...
export default function registerPresentation(pi, { session }) {
  ...
  pi.registerTool({
    name: "present",
    label: "Present",
    description: "Present a complete navigable deck through wt's Neovim canvas. Markdown scenes should use fenced Mermaid diagrams as the default visual language for relationships; the user's Neovim plugins render them. Neovim owns slide navigation locally with H/L/q so the user can move without model round trips.",
    promptSnippet: "Present navigable Neovim walkthroughs with Mermaid-first Markdown diagrams",
    promptGuidelines: [
